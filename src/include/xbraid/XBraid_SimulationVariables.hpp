...
struct XBraid_SimulationVariables
{
	...
	void outputConfig()
	{
		...
		std::cout << " + xbraid_spectral_ref: "                 << xbraid_spectral_ref                 << std::endl;
	...
	void printOptions()
	{
		...
		std::cout << "	--xbraid-spectral-ref [int]                  XBraid parameter spectral_ref, default: ''"                << std::endl;
	...
	)
	{
		...
		io_long_options[io_next_free_program_option] = {"xbraid-spectral-ref", required_argument, 0, 256+io_next_free_program_option};
		io_next_free_program_option++;
	...
	)
	{
		switch(i_option_index)
		{
			...
			case 30: xbraid_spectral_ref              = atoi(optarg);	return -1;
			case 31: xbraid_load_fine_csv_files       = atoi(optarg);	return -1;
			case 32: xbraid_path_fine_csv_files       = optarg;		return -1;
			case 33: xbraid_store_iterations          = atoi(optarg);	return -1;
			case 34: xbraid_spatial_coarsening        = atoi(optarg);	return -1;
		}
		return 35;
	}
