                                ...
                                for fmg_vcyc in fmg_vcycs:
                                    ...
                                    for nrelax in nrelaxs:
                                        ...
                                        for tsm in tsms:
                                            ...
                                            for viscosity_order1 in viscosity_orders:

                                                for viscosity_order2 in viscosity_orders:

                                                    for viscosity_coefficient1 in viscosity_coefficients[viscosity_order1]:

                                                        for viscosity_coefficient2 in viscosity_coefficients[viscosity_order2]:

                                                            if plot_solution:
                                                                jg.runtime.xbraid_store_iterations = 1;
                                                                if [nb_levels, cfactor, nrelax, coarsening, tsm] not in [[3,2,5,51,"l_irk_n_erk"],[3,2,5,128,"l_irk_n_erk"],[2,2,5,51,"l_irk_na_sl_nr_settls_uv_only"],[2,2,5,128,"l_irk_na_sl_nr_settls_uv_only"]]:
                                                                    continue
