...
cases = [
            ...
            ["l_irk_n_erk", 2, 2, 1, 51, 2, 1e6, 2, 1e6],
            ["l_irk_n_erk", 2, 2, 5, 51, 2, 1e6, 2, 1e6],
            ["l_irk_n_erk", 2, 2, 0, 128, 2, 1e6, 2, 1e6],
            ["l_irk_n_erk", 2, 2, 1, 128, 2, 1e6, 2, 1e6],
            ["l_irk_n_erk", 2, 2, 5, 128, 2, 1e6, 2, 1e6],
            ["l_irk_n_erk", 3, 2, 0, 128, 6, 1e27, 6, 1e27],
            ["l_irk_n_erk", 3, 2, 0, 128, 2, 0, 2, 1e7],
            ["l_irk_n_erk", 3, 2, 0, 128, 2, 0, 4, 1e17],
            ["l_irk_n_erk", 3, 2, 0, 128, 2, 0, 6, 1e27],
