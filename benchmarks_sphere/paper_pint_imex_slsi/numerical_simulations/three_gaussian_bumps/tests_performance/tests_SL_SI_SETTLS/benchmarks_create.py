...
cases = [
            ["l_irk_na_sl_nr_settls_uv_only", 2, 2, 0, 51, 2, 1e6, 2, 1e6],
            ["l_irk_na_sl_nr_settls_uv_only", 2, 2, 1, 51, 2, 1e6, 2, 1e6],
            ["l_irk_na_sl_nr_settls_uv_only", 2, 2, 5, 51, 2, 1e6, 2, 1e6],
            ["l_irk_na_sl_nr_settls_uv_only", 2, 2, 0, 128, 2, 1e6, 2, 1e6],
            ["l_irk_na_sl_nr_settls_uv_only", 3, 2, 0, 128, 2, 0, 2, 1e7],
            ["l_irk_na_sl_nr_settls_uv_only", 3, 2, 0, 128, 2, 1e7, 2, 1e7],
            ["l_irk_na_sl_nr_settls_uv_only", 3, 2, 0, 128, 4, 1e17, 2, 1e7],
            ["l_irk_na_sl_nr_settls_uv_only", 3, 2, 0, 128, 6, 1e27, 2, 1e7],
