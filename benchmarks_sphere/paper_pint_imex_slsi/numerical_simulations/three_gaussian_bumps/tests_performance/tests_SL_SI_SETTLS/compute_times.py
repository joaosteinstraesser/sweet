...
exclude_vals = [
                   ...
                   #["l_irk_na_sl_nr_settls_uv_only", 2, 2, 1, 51, 1e6, "--"],
                   #["l_irk_na_sl_nr_settls_uv_only", 2, 2, 5, 51, 1e6, "--"],
                   ####["l_irk_n_erk", 2, 2, 0, 128, 1e6, "--"],
                   #["l_irk_na_sl_nr_settls_uv_only", 2, 2, 1, 128, 1e6, "--"],
                   ####["l_irk_n_erk", 2, 2, 5, 128, 1e6, "--"],
                   #["l_irk_na_sl_nr_settls_uv_only", 3, 2, 0, 128, 1e27, 1e27],
